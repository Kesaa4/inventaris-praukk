...
<div class="main-content">
    ...
    <?php endif ?>
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-body">
                    <form method="get" action="<?= base_url('barang') ?>" class="row g-2 g-md-3 align-items-end" id="filterForm">
                        ...
                        <div class="col-12 col-md d-flex flex-column flex-md-row justify-content-between gap-2">
                            ...
                            <?php if (session()->get('role') === 'admin'): ?>
                                <div class="d-flex flex-column flex-sm-row gap-2">
                                    <a href="<?= base_url('barang/create') ?>" class="btn btn-success btn-sm">
                                        <i class="bi bi-plus-circle me-1"></i>Tambah<span class="d-none d-sm-inline"> Barang</span>
                                    </a>
                                    <a href="<?= site_url('barang/trash') ?>" class="btn btn-danger btn-sm">
                                        <i class="bi bi-trash me-1"></i><span class="d-none d-sm-inline">Barang </span>Terhapus
                                    </a>
                                </div>
                            <?php endif ?>
                        </div>
                ...
                <table class="table table-bordered table-hover align-middle mb-0">
                    <thead class="table-primary text-center">
                        <tr>
                            ...
                            <th class="text-nowrap d-none d-md-table-cell">Tipe</th>
                            <th class="text-nowrap">Kode</th>
                            <th class="text-nowrap d-none d-lg-table-cell">RAM</th>
                            <th class="text-nowrap d-none d-lg-table-cell">ROM</th>
                            <th class="text-nowrap d-none d-md-table-cell">Kondisi</th>
                            <th class="text-nowrap">Foto</th>
                            <th class="text-nowrap">Status</th>
                            <th class="text-nowrap d-none d-xl-table-cell">Keterangan</th>
                            <?php if (session()->get('role') === 'admin'): ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-nowrap"><?= esc($b['nama_kategori']) ?></td>
                            <td class="text-nowrap"><?= esc($b['merek_barang']) ?></td>
                            <td class="text-nowrap d-none d-md-table-cell"><?= esc($b['tipe_barang']) ?></td>
                            <td class="text-nowrap"><?= esc($b['kode_barang']) ?></td>
                            <td class="text-nowrap d-none d-lg-table-cell"><?= esc($b['ram']) ?></td>
                            <td class="text-nowrap d-none d-lg-table-cell"><?= esc($b['rom']) ?></td>
                            <td class="text-nowrap d-none d-md-table-cell"><?= esc($b['kondisi']) ?></td>
                            ...
                            <td class="text-nowrap d-none d-xl-table-cell"><?= esc($b['keterangan']) ?></td>
                        ...
                        <tr>
                            <td colspan="12" class="text-center text-muted py-4">
                                <i class="bi bi-inbox"></i> Data barang kosong
                            </td>
                        </tr>
                        <?php endif ?>
                    </tbody>
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="mt-2">
                            <small class="text-muted">
                                <?= esc($b['nama_kategori']) ?> - <?= esc($b['merek_barang']) ?> - <?= esc($b['tipe_barang']) ?>
                            </small>
                        </div>
                    </div>
                </div>
